    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="form">
            <div>
                ...
                <p style="float: left;" class="left_txt2">客户收（付）款明细</p>
                <div align="center" style="float: left;margin-left: 40%">
                    <a href='getpaymon?id=${cusid}' class="btn btn-success"><span
                            class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;收付款</a>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <table id="bal" style="background-color: white" align="center" width="800" cellpadding="3"
...
<script type="text/javascript">
    ...
    function build_bal_table(result) {
        ...
        $.each(bal, function (index, item) {
            ...
            var paidtime = $("<td></td>").append(d.toLocaleDateString());
            var username = $("<td></td>").append(item.users.username);
            var demo = $("<td></td>").append(item.demo);
            var b2 = $("<button class='b2'></button>").addClass(
                "btn btn-danger btn-sm").append("作废");
                b2.attr("zuofei", item.balanceid);
    ...
    $(document).on("click", ".b2", function () {
        //弹出是否确认删除对话框
        var bid = $(this).attr("zuofei");
        layer.confirm("确认作废这条收(付)款开单吗？", {
            btn: ['确认', '取消'] //按钮
        }, function () {
            //确认，发送ajax请求删除即可
            $.ajax({
