    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="form">
            <div>
                ...
                <div align="center" style="float: left;margin-left: 50%">
...
<script type="text/javascript">
    ...
    function build_CDbyCIDlist_table(result) {
        ...
        var cardelist = result.extend.pageInfo.list;

        $.each(cardelist, function (index, item) {
            d.setTime(item.oprtime);
            var detailid = $("<td></td>").append(item.detailid);
            var oprtime = $("<td></td>").append(d.toLocaleDateString());
            ...
            $("<tr></tr>").append(detailid).append(oprtime).append(cardno).
            append(customername).append(customername1).append(goodsname).append(unitname).
            append(gcount).append(sendfee).append(gcount).append(insurancefee).
            append(otherfee).append(areaname).append(areaname1).append(orderid).
            appendTo("#CDbyCIDlist tbody");
        });
    }
    //解析显示分页信息
