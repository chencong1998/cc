            ...
            <div>
                ...
                <div align="center" style="float: left;margin-left: 40%">
                    <%--<img src="images/ico_Form.gif" width="14" height="14"/>&nbsp;--%><a
                        href='addCus' class="btn btn-success"><span
...
<script type="text/javascript">
    ...
    function build_cus_table(result) {
        ...
        $.each(cuss, function (index, item) {
            ...
            var b1 = $("<button onclick="+"javascript:window.location.href='getpaymon?id="+ item.customerid +"'></button>").addClass(
                "btn btn-primary btn-sm").append("收/付款");
            var b2 = $("<button onclick="+"javascript:window.location.href='balance?cusid="+ item.customerid +"'></button>").addClass(
                "btn btn-success btn-sm").append("收付款明细");
            var b3 = $("<button onclick="+"javascript:window.location.href='cardebycid?cusid="+ item.customerid +"'></button>").addClass(
                "btn btn-info btn-sm").append("订单明细");
            var b4 = $("<button onclick="+"javascript:window.location.href='getcus?cusid="+ item.customerid +"'></button>").addClass(
                "btn btn-warning btn-sm").append("修改");
            var b5 = $("<button class='btn-danger'></button>").addClass(
                "btn btn-danger btn-sm").append("删除");
            b5.attr("del-id", item.customerid);
