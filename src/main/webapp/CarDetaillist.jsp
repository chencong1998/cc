    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="form">
            <div>
                ...
                <p style="float: left;" class="left_txt2">订单明细列表</p>
                ...
                <table id="carde" style="background-color: white" align="center" width="800" cellpadding="3"
...
<script type="text/javascript">
    ...
    var d=new Date();
    function build_carde_table(result) {
        //清空table表格
        $("#carde tbody").empty();
        var carde = result.extend.pageInfo.list;
        $.each(carde, function (index, item) {
