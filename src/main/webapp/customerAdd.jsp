                ...
                <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <CENTER>
                            <form action="./CustomerServlet?action=add&currPage=1&opr=first" method="post" name="form1"
                                ...
                                <table align="center" border="1" cellpadding="2" cellspacing="1" style="width: 300px">
                                    ...
                                    <tr class="input-group" style="width: 300px;height:42px">
                                        ...
                                        <td><input style="border: none;height: 30px" type="text" name="faceMoney" class="form-control" placeholder="FaceMoney"
                                                   aria-describedby="basic-addon1"></td>
                                    </tr>
                                    <tr class="input-group" style="width: 300px;height:42px">
                                        <td align="right" class="input-group-addon" id="basic-addon8">应收账款：</td>
